...
/* Database object common at the whole module */
var db;


/**
 * Basic function trying to open the database; set the database object on success
*/
...
var getNewSet=function(calling_language, rowid, callback) {
    ...
    if (!calling_language.querys) {
        ...
        var tempRequire=require("./lib/parallelarray.js");
        
        var params=tempRequire.buildQueryAndParamsArray(calling_language,rowid);
        
        console.log(params);
        
        tempRequire.parallelOnArray(db,params.querysArray,params.querysParams,function(err,results){
            var tempResults={};
            results.forEach(function(result,index){
                tempResults[params.map[index]]=result;
            });
